...
(function (d) {
    ...
    }) : "object" === typeof exports ? module.exports = function (q, p) {
        q || (q = window);
        if (!p || !p.fn.dataTable) p = require("datatables.net")(q, p).$;
        return d(p, q, q.document)
    ...
    var i = d.fn.dataTable, w = 0, x = 0, k = i.ext.buttons, n = function (a, b) {
        if (!(this instanceof
            n)) return function (b) {
    ...
    d.extend(n.prototype, {
        action: function (a, b) {
            ...
            var c = this._nodeToButton(a), e = this.c.dom.collection.buttonLiner,
                e = c.inCollection && e && e.tag ? e.tag : this.c.dom.buttonLiner.tag, g = this.s.dt, f = d(c.node),
                h = function (a) {
            ...
            for (var g = this.s.dt, f = 0, b = !d.isArray(b) ? [b] : b, h = 0, l = b.length; h < l; h++) {
                ...
                if (o) if (d.isArray(o)) this._expandButton(a, o, c, e); else {
            ...
            var l = function (a, b, c, e) {
                    ...
                    d(b.table().node()).triggerHandler("buttons-action.dt",
                        [b.button(c), b, c, e])
                }, g = a.tag || c.tag, o = a.clickBlurs === m ? !0 : a.clickBlurs,
                j = d("<" + g + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function (b) {
                    ...
                    b.keyCode === 13 && !j.hasClass(c.disabled) && a.action && l(b, f, j, a)
                });
                ...
                var c =
                    function (e) {
                        for (var g = 0, f = e.length; g < f; g++) {
                            var h = e[g].conf, l = e[g].node;
                            if (h.key) if (h.key === a) b._buttonsHandled = !0, d(l).click(); else if (d.isPlainObject(h.key) && h.key.key === a && (!h.key.shiftKey || b.shiftKey)) if (!h.key.altKey || b.altKey) if (!h.key.ctrlKey || b.ctrlKey) if (!h.key.metaKey || b.metaKey) b._buttonsHandled = !0, d(l).click();
            ...
            var l = d(b.table().container()), e = c.css("position");
            "dt-container" === g.align && (f = f.parent(), c.css("width", l.width()));
            if ("absolute" === e) {
                e = f.position();
                c.css({top: e.top + f.outerHeight(), left: e.left});
                var o = c.outerHeight(), j = c.outerWidth(), i = l.offset().top + l.height(),
                    i = e.top + f.outerHeight() + o - i, m = e.top - o, k = l.offset().top, o = e.top - o - 5;
    ...
    i.Api.register("buttons.exportInfo()", function (a) {
        ...
        return {
            filename: b,
            title: c,
            messageTop: v(this, a.message || a.messageTop, "top"),
