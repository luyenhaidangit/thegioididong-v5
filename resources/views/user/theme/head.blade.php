...
<link href="{!! asset('/frontend/assets/css/lightgallery.min.css" rel="stylesheet') !!}">
<link href="{!! asset('/frontend/assets/css/lightslider.css" rel="stylesheet') !!}">
<link href="{!! asset('/frontend/assets/css/prettify.css" rel="stylesheet') !!}">
{{--profiles--}}
<link href="{!! asset('/frontend/assets/css/awesome.min.css') !!}" rel="stylesheet">
